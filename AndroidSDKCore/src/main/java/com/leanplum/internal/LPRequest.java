...
public class LPRequest implements LPRequesting {
  ...
  public static LPRequest get(String apiMethod, Map<String, Object> params) {
    ...
    return new LPRequest("GET", apiMethod, params);
  }

  public static LPRequest post(String apiMethod, Map<String, Object> params) {
    Log.LeanplumLogType level = Constants.Methods.LOG.equals(apiMethod) ?
        Log.LeanplumLogType.DEBUG : Log.LeanplumLogType.VERBOSE;
    Log.log(level, "Will call API method " + apiMethod + " with arguments " + params);
